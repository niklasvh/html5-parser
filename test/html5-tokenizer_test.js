...
(function(path) {
    fs.readdirSync(path).filter(function(name) {
        return ["inbody01.dat", "tables01.dat", "main-element.dat", "tests2.dat",  "tests3.dat", "tests4.dat", "tests5.dat", "tests6.dat", "tests8.dat", "tests9.dat", "tests14.dat", "tests17.dat", "tests18.dat", "tests20.dat", "webkit02.dat", "tests24.dat", "tests25.dat"].indexOf(name) !== -1;
