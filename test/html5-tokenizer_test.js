...
(function(path) {
    fs.readdirSync(path).filter(function(name) {
        return ["adoption01.dat", "adoption02.dat", "comments01.dat", "doctype01.dat", "domjs-unsafe.dat", "inbody01.dat", "tables01.dat", "main-element.dat",
            "tests1.dat", "tests2.dat",  "tests3.dat", "tests4.dat", "tests5.dat", "tests6.dat", "tests7.dat", "tests8.dat", "tests9.dat", "tests14.dat", "tests15.dat", "tests16.dat", "tests17.dat", "tests18.dat", "tests20.dat", "tests24.dat", "tests25.dat", "webkit02.dat"].indexOf(name) !== -1;
