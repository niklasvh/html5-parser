    ...
    Node.prototype.appendChild = function(child) {
        ...
        if (child.nodeType === nodeType.TEXT_NODE) {
            ...
            if (len && this.childNodes[len - 1].nodeType === nodeType.TEXT_NODE) {
                this.childNodes[len - 1].text += child.text;
            } else {
    ...
    Parser.prototype.insertCharacter = function(chr) {
        ...
        if (this.fosterParented && this.tokenizer.state !== this.tokenizer.states.plaintext) {
            ...
            if (count && this.currentNode().childNodes[count - 1].nodeType === nodeType.TEXT_NODE) {
                this.currentNode().childNodes[count - 1].text += chr;
            } else {
    ...
    Parser.prototype.adoptionAgencyAlgorithm = function(token) {
        ...
        while (outerLoop < 8) {
            ...
            while (innerLoop < 3) {
                ...
                element = this.constructor.createElement(node.tagName);
            ...
            element = this.constructor.createElement(formattingElement.tagName);
