        ...
        if (character === characters.BRACES_OPEN) {
            ...
            switch(character) {
                ...
                case characters.SOLIDUS:
                    ...
                    if (end[0] === characters.BRACES_CLOSE && end[1] === characters.BRACES_CLOSE) {
                        this.addAttribute();
                        if (!this.openAttributeSections.length || this.openAttributeSections.pop().name !== String.fromCharCode.apply(String, mustacheData)) {
                            throw "Attempting to close attribute section " + String.fromCharCode.apply(String, mustacheData);
                        }
                        this.setState(this.mustacheState);
                        return;
                    }
