...
(function(exports) {
    ...
    Parser.prototype.pushActiveFormatting = function(element) {
        ...
        while((item = this.activeFormattingElements[markerIndex])) {
            if (element.tagName === item.tagName && element.namespace === item.namespace) {
        ...
        if (count >= 3) {
            console.log('splicing', first, this.activeFormattingElements);
    ...
    Parser.prototype.in_body = function(token) {
        ...
        //    this.generalFormatterEnd(token, this.hasElementInScope);
            ...
            if (this.getElementBetweenMarkerAndEnd("a") !== -1) {
                this.parseError();
    ...
    Parser.prototype.insertNodeInAppropriatePlace = function(node, overrideTarget) {
        ...
        appropriatePlace.parent.children.splice(appropriatePlace.index, 0, node);
        ...
        if (this.fosterParented && (/^(table|tbody|tfoot|thead|tr)$/).test(target.tagName)) {
            ...
            if (!lastTable) {
                return {
                    ...
                    index: this.openElements[0].children.length
                };
            }
            ...
            if (lastTable.parentNode) {
                return {
                    ...
                    index: this.indexIn(lastTable, lastTable.parentNode.children)
                };
            }
            ...
            adjustedInsertionLocation = {
                ...
                index: previousElement.children.length
            };
        } else {
            adjustedInsertionLocation = {
                parent: target,
    ...
    Parser.prototype.getElementBetweenMarkerAndEnd = function(tagName) {
        ...
        return tagNames.lastIndexOf(tagName, tagNames.length - (lastMarker !== -1 ? lastMarker : 0));
    };
    ...
    Parser.prototype.clearUntilLastMarker = function() {
        var index = this.indexIn("marker", this.activeFormattingElements);
        this.activeFormattingElements.splice(index);
    };
