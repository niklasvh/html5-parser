...
(function(exports) {
    ...
    function Parser(html, options) {
        ...
        switch(this.options.type) {
            case "tree":
                return this.constructor.childNodes;
            case "tokens":
    ...
    Parser.prototype.insertCharacter = function(chr) {
        ...
        if (this.fosterParented && this.tokenizer.state !== this.tokenizer.states.plaintext) {
            ...
            len = this.currentNode().childNodes.length;
            if (len && this.currentNode().childNodes[len - 1].type === tokenType.character) {
                this.currentNode().childNodes[len - 1].text += chr;
            } else {
