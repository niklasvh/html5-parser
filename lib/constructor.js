(function(exports) {
  ...
  Constructor.prototype.createBlock = function(name) {
    var element = this.createElement(name);
    element.nodeType = -2;
    return element;
  };

  Constructor.prototype.createWithBlock = function(type, name) {
  ...
  DummyNode.prototype.appendVariable = function(name) {
    this.childNodes.push(new Variable(name));
  };
